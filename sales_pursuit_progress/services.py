...
def create_sales_pursuit_progress(item_form_data: SalesPursuitProgressCreate):
    ...
    try:
        ...
        if new_item:
            ...
            error_response = {"msg": "Sales Pursuit Progress created sucessfully", "code": 201, "data": data}
            return json.dumps(error_response)
        else:
            error_response = {"msg": "Sales Pursuit Progress already exists", "code": 400}
            return json.dumps(error_response)

    except psycopg_errors.UniqueViolation as e:
        # Catch psycopg2 UniqueViolation error
        error_response = {"msg": "Sales Pursuit Progress already exists", "code": 409}
        return json.dumps(error_response)
