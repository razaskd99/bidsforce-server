...
@router.delete("/bid_validity/all-rfx/tenant_id/{tenant_id}", tags=["Bid Validity"], summary="Delete an Bid Validity", description="This method will delete Bid Validity")
