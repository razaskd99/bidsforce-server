...
def create_bidding_unit(item_form_data: BiddingUnitCreate):
    ...
    try:
        ...
        if new_item:
            ...
            error_response = {"msg": "Bidding Unit created sucessfully", "code": 201, "data": data}
            return json.dumps(error_response)
        else:
            error_response = {"msg": "Bidding Unit already exists", "code": 400}
            return json.dumps(error_response)

    except psycopg_errors.UniqueViolation as e:
        # Catch psycopg2 UniqueViolation error
        error_response = {"msg": "Bidding Unit already exists", "code": 409}
        return json.dumps(error_response)
