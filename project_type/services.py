...
def create_project_type(item_form_data: ProjectTypeCreate):
    ...
    try:
        ...
        if new_item:
            ...
            error_response = {"msg": "Project Type created sucessfully", "code": 201, "data": data}
            return json.dumps(error_response)
        else:
            error_response = {"msg": "Project Type already exists", "code": 400}
            return json.dumps(error_response)

    except psycopg_errors.UniqueViolation as e:
        # Catch psycopg2 UniqueViolation error
        error_response = {"msg": "Project Type already exists", "code": 409}
        return json.dumps(error_response)
